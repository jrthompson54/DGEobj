...
Note, there is no facility provided to assign rownames or colnames to a DGEobj.  This is because I can't guarantee that an object stored in the DGEobj has row/colname assignment support.
